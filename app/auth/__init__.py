...
def handle_auth_error(e):
    return {'message': 'Bạn không có quyền truy cập vào tài nguyên này.', 'code': -1}, 401
...
def unauthorized(error):
    return jsonify({'message': 'Yêu cầu của bạn bị trừ chối vì bạn không được phép truy cập tài nguyên này. Vui lòng đăng nhập bằng tài khoản có quyền phù hợp.', 'code': -1}), 401
